...
try {
  module.exports = function() {
    ...
    View.ensureCodeBehind( CODE_BEHIND, "onSmallChanged" );
    //-------------------
    // Global functions.
    ...
    var ViewClass = function( args ) {
      try {
        ...
        pm.create("tag", { cast: stringCast() });
        pm.create("icon");
        pm.create("content", { cast: stringCast() });
        pm.create("pressed", { cast: booleanCast() });
        pm.create("flat", { cast: booleanCast() });
        pm.create("type", { cast: enumCast(["default","primary","secondary"]) });
        pm.create("enabled", { cast: booleanCast() });
        pm.create("inverted", { cast: booleanCast() });
        pm.create("visible", { cast: booleanCast() });
        pm.create("width", { cast: unitCast() });
        pm.create("wide", { cast: booleanCast() });
        pm.create("responsive", { cast: booleanCast() });
        pm.create("small", { cast: booleanCast() });
        //------------------
        // Create elements.
        ...
        new Link({
          ...
          B:{action: function(v) {
          e_.applyClass(
            CODE_BEHIND.getClasses.call(that), 0);}}
        });
        new Link({
        ...
        pm.on('content', function(v) { $.clear(e_text, v); });
        //----------------------
        // Initialize elements.
        ...
        this.content = defVal(args, "content", "Click me!");
