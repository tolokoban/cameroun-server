...
try {
  module.exports = function() {
    ...
    var stringsCast = Converters.get('strings');
    //-------------------
    // Class definition.
    var ViewClass = function( args ) {
      try {
        ...
        //--------------------
        // Create attributes.
        pm.create("value", { cast: stringCast() });
        pm.create("label", { cast: stringCast() });
        pm.create("focus", { cast: booleanCast() });
        pm.create("visible", { cast: booleanCast() });
        pm.create("width", { cast: unitCast() });
        pm.create("list", { cast: stringsCast() });
        //------------------
        // Create elements.
