...
function onIndexChange( index ) {
  console.info("[tfw.view.combo] onIndexChange=", index);
...
function onValueChange( value ) {
  console.info("[tfw.view.combo] onValueChange=", value);
  let index = 0;
  if ( hasKeys.call( this ) ) {
    ...
    console.info("[tfw.view.combo] this.keys=", this.keys);
    console.info("[tfw.view.combo] index=", index);
    if ( index < 0 ) index = 0;
    PM( this ).set( "index", index );
  } else {
    console.log( "hasKeys === false" );
  ...
  console.info("[tfw.view.combo] this.index=", this.index);
